...
#                       module_drawer=RoundedModuleDrawer(radius_ratio=1),
#                       eye_drawer=RoundedModuleDrawer(radius_ratio=1),
#                       color_mask=SolidFillColorMask(back_color=(222, 246, 74), front_color=(255, 255, 255)),
#                       embeded_image_path="activ-logo-noback.png")
# img_2 = qr.make_image(image_factory=StyledPilImage,
#                       module_drawer=RoundedModuleDrawer(radius_ratio=1),
#                       eye_drawer=RoundedModuleDrawer(radius_ratio=1),
#                       color_mask=SolidFillColorMask(back_color=(255, 255, 255), front_color=(222, 246, 74)),
#                       embeded_image_path="activ-logo-noback.png")